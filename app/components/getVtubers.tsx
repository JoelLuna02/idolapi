...
export default async function VTubers() {
  ...
  return (
    <>
      <section style={{ backgroundColor: '#010203' }}>
        ...
        <div className="container-xxl p-4">
          <div className="divider d-flex align-items-center my-4">
            <h1 className="text-center fw-bold mx-3 mb-0 text-white">Idol VTubers</h1>
          </div>
              ...
              return (
                <>
                  <div className="col-md-6" key={vtuber.id}>
                    <div className="card mb-1 mt-1 shadow rounded-fill bg-dark text-white">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="#010203" fillOpacity={1} d="M0,64L21.8,90.7C43.6,117,87,171,131,181.3C174.5,192,218,160,262,128C305.5,96,349,64,393,48C436.4,32,480,32,524,58.7C567.3,85,611,139,655,133.3C698.2,128,742,64,785,80C829.1,96,873,192,916,234.7C960,277,1004,267,1047,224C1090.9,181,1135,107,1178,96C1221.8,85,1265,139,1309,165.3C1352.7,192,1396,192,1418,192L1440,192L1440,0L1418.2,0C1396.4,0,1353,0,1309,0C1265.5,0,1222,0,1178,0C1134.5,0,1091,0,1047,0C1003.6,0,960,0,916,0C872.7,0,829,0,785,0C741.8,0,698,0,655,0C610.9,0,567,0,524,0C480,0,436,0,393,0C349.1,0,305,0,262,0C218.2,0,175,0,131,0C87.3,0,44,0,22,0L0,0Z"></path>
      </svg>
      </section>
    </>
  )
